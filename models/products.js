...
Product.define('positiveRating', Number);
Product.define('discount', Number);
Product.define('stars', Number);
Product.define('brandId', String);
Product.define('brandName', String);
...
Product.setQuery(function(error, options, callback) {
	...
	var filter = function(doc) {
		...
		if (options.ids && options.ids.indexOf(doc.id) === -1)
			return;
