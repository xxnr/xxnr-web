...
Order.define('buyer', String);
Order.define('status', 'String(100)');
Order.define('delivery', 'String(30)');
Order.define('firstname', 'String(40)');
Order.define('lastname', 'String(40)');
Order.define('email', 'String(200)');
...
Order.setQuery(function(error, options, callback) {
	...
	var filter = function(doc) {
		...
		if (options.buyer && (doc.buyer !== options.buyer))
			return;
