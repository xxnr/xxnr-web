...
include_once __DIR__ . DIRECTORY_SEPARATOR . 'PublicEncrypte.php';
include_once __DIR__ . DIRECTORY_SEPARATOR . 'common.php';
include_once __DIR__ . DIRECTORY_SEPARATOR . 'log.class.php';
...
function sign(&$params) {
	...
	$key = (($certType == 'public-key') ? getPublicKey($cert_path) : getPrivateKey ( $cert_path ));
	// 签名
	$sign_falg = openssl_sign ( $params_sha1x16, $signature, $key, OPENSSL_ALGO_SHA1 );
	if ($sign_falg) {
