...
var default_alipay_config = {
	...
	,refund_fastpay_by_platform_nopwd_notify_url : '/alipay/refund_fastpay_by_platform_nopwd/notify_url'
...
function Alipay(alipay_config){		
    ...
    this.alipaySubmit = new AlipaySubmit(this.alipay_config);
}
...
Alipay.prototype.build_direct_pay_by_user_param = function(data){
	...
	console.log('alipay parameter = ' + JSON.stringify(parameter));
	return this.alipaySubmit.buildRequestPara(parameter);
}
...
// Alipay.prototype.build_refund_fastpay_by_platform_nopwd_param = function(data){
// 	assert.ok(data.batch_no && data.batch_num && data.detail_data);

// 	//构造要请求的参数数组，无需改动
// 	var parameter = {
// 		service: 'refund_fastpay_by_platform_nopwd',
// 		partner: this.alipay_config.partner,
// 		notify_url: url.resolve(this.alipay_config.host, this.alipay_config.refund_fastpay_by_platform_nopwd_notify_url),
...
Alipay.prototype.build_refund_fastpay_by_platform_pwd_param = function(data){
