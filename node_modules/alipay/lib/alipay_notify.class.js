...
AlipayNotify.prototype.getSignVeryfy = function(para_temp, sign){
    var sign_type = para_temp.sign_type.trim().toUpperCase();
    //除去待签名参数数组中的空值和签名参数
    ...
    if(sign_type == "MD5"){
        ...
        isSgin = md5_f.rsaVerify(prestr, sign, this.alipay_config['ali_pub_key']);
    }else{
        isSgin = false;
    }
    return isSgin;
...
AlipayNotify.prototype.getResponse = function(notify_id, callback){
    ...
    var veryfy_url = this.https_verify_url;
